...
namespace Api_intro.Services
{
    public class CountryService : ICountryService
    {
        ...
        {
            var existCountry = await _context.Countries.AsNoTracking()
        ...
        {
            return _mapper.Map<List<CountryDto>>(await _context.Countries.AsNoTracking()
                                                                         .ToListAsync());
        }

        public async Task<CountryDto> GetByIdAsync(int id)
        {
            var result = await _context.Countries.AsNoTracking()
